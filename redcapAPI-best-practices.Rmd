...
Using `makeApiCall`, we can get User-Roles, even though `redcapAPI`
...
FIXME: This one needs an example

### Cornacopia of Functions to explore

FIXME: Benjamin--mention a lot of new functions to explore but
nothing in depth. 
