...
of the package gets this for **free** and by specifying `retries=10` it will try up to 30 minutes per call if necessary--allowing for downtime under this to not affect the generation of a report. This is important on automated systems that require reliability and can wait.  
