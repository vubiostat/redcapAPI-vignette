...
The `enviro` argument specifies an environment to write the connections into. 
If not specified, one gets a named list of the requested connections opened.
...
The environment post execution contains the data.frames: `test.form1`,
`test.form2`, `sand`. Each of these were retrieved, possibly using the forms
...
FIXME: Note-- I think most of the new functionality is covered in 
post-processing. This table should over a good overview of what the package
offers though. 
