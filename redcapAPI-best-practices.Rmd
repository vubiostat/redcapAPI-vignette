...
The `widerRepeated` function converts this data frame into a short and wide one. 
...
RecordsWide <- widerRepeated(Records, rcon)
```
...
are the same. If this is not the case, an error message will display.
